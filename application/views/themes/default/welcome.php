<?php if(!empty($posts)):?>
  ...
  <div class="panel panel-default"><!-- Post -->
      ...
      <div class="panel-footer">
        <div class="post-meta">
          <span class="text-left"><i class="fa fa-calendar"></i> <?php echo date('d M Y',strtotime($post['published_at']))?> <i class="fa fa-bars"></i> <a href="#">Web Design</a>, <a href="#">Bootstrap</a></span> 
